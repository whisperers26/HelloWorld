    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button3__Click(object sender, EventArgs e)
        {
            ...
            if (linkedListNode == null) Console.WriteLine("Not found");
            else
            {
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            // 2. Your code here
            string[] words = {"Because", "I'm", "sad","Clap","along","if","you","feel","like","a","room","without","a","roof",
            "Because", "I'm", "sad","Clap","along","if","you","feel","like","sadness","is","the","truth", "sad"};
            s = words;
            ...
            do
            {
                if ((string)linkedListNode.Value == "sad") linkedListNode.Value = "happy";
                else if ((string)linkedListNode.Value == "sadness") linkedListNode.Value = "happiness";
                linkedListNode = linkedListNode.Next;
            } while (linkedListNode != null);
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            // 4. Your code here
            //local function to move a node after one node
            void MoveNode(LinkedListNode<object> nodeToMove, LinkedListNode<object> nodeBefore)
            {
                linkedList.Remove(nodeToMove);
                linkedList.AddAfter(nodeBefore, nodeToMove);
            }

            linkedListNode1 = linkedList.Find("The");
            linkedListNode2 = linkedList.Find("rain");
            MoveNode(linkedListNode2, linkedListNode1);
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            // Your code here
            LinkedListNode<object> linkedListNodeReplace;
            
            string[] letters2 = { "D", "I", "R", "T", "Y", "R", "O", "O", "M" };
            LinkedList<object> anagram2 = new LinkedList<object>(letters2);
            linkedListNode1 = anagram.First;
            linkedListNode2 = anagram2.First;

            do
            {
                if ((string)linkedListNode1.Value != (string)linkedListNode2.Value)
                {
                    linkedListNodeReplace = anagram.FindLast(linkedListNode2.Value);
                    anagram.Remove(linkedListNodeReplace);
                    anagram.AddAfter(linkedListNode1.Previous, linkedListNodeReplace);
                    linkedListNode1 = linkedListNodeReplace;
                }
